...
public class PreferencesInscriptionActivity extends AppCompatActivity implements View.OnClickListener, CompoundButton.OnCheckedChangeListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //liaison avec le XML
        setContentView(R.layout.activity_preferences_inscription);
        ...
        switch_all.setOnCheckedChangeListener(PreferencesInscriptionActivity.this);
        //action quand on click sur  bouton.Appel de la méthode onClick
        bfa.setOnClickListener(PreferencesInscriptionActivity.this);
